             ...
             switch(opcao){
                    case "cadastrar":
                        ...
                        for(i=0;i<total;i++){
                            ...
                            dataEntrevista.setTime(formatador.parse(request.getParameter("dataEntrevista"+k)+" "+request.getParameter("horario"+k)));
                            entrevista.setDataEntrevista(dataEntrevista);
                            entrevista.setLocal(request.getParameter("local"+k));
                        ...
                        //Chamando o metodo inserir do dao e redirecionando para listar entrevista                       
                    ...
                    case "entrevistar":
                        ...
                        entrevista = daoFactory.getEntrevistaDao().pesquisarPorId(Integer.parseInt(request.getParameter("e_id")));
