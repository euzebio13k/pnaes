...
public class DaoFactory {
    ...
    public DaoGenerico<Aluno> getAlunoDao(){
        return new DaoGenerico<Aluno>(Aluno.class);
    }
  
    public DaoGenerico<OrcamentoMensal>getOrcamentoMensalDao(){
        return new DaoGenerico<OrcamentoMensal>(OrcamentoMensal.class);
    }
     public DaoGenerico<Empresa> getEmpresaDao(){
        return new DaoGenerico<Empresa>(Empresa.class);
    }
   
    public DaoGenerico<Entrevista> getEntrevistaDao(){
        return new DaoGenerico<Entrevista>(Entrevista.class);
    }
    ...
    public DaoGenerico<PessoaJuridica> getPessoaJuridicaDao(){
        return new DaoGenerico<PessoaJuridica>(PessoaJuridica.class);
    }
    ...
    public DaoGenerico<Documento>getDocumentoDao(){
        return new DaoGenerico<Documento>(Documento.class);
    }
