                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <table class="table table-bordered">
                                                            ...
                                                            <%
                                                                for (Visita vi : visita) {
                                                            %>
                                                            <tr>

                                                                <td><%=vi.getInscricao().getId()%></td>
                                                                <td><%=vi.getInscricao().getAluno().getNome()%></td>
                                                                <td><%=dataFormat.formatarData(vi.getDataVisita())%></td>
                                                                <td><%=dataFormat.formatarHora(vi.getDataVisita())%></td>          
                                                                <td><a href="alterar.jsp?id=<%=vi.getId()%>">Editar</a></td>
                                                                <td><a href="#" onclick="apagar(<%=vi.getId()%>)">Excluir</a></td>
                                                            </tr>
                                                            <%
                                                                }
                                                            %>
