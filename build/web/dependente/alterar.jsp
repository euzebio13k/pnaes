                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form  class="form form-horizontal striped-rows form-bordered" method="Post" action="../ServletDependente?opcao=alterar&id=<%=dependente.getId()%>">
                                                        <div class="form-body">
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-md-3 label-control" for="tipoDeficiencia">Tipo de Deficiencia</label>
                                                                <div class="col-md-9">
                                                                    <input type="text" name="tipoDeficiencia" id="tipoDeficiencia" class="form-control" value="<%=dependente.getTipoDeficiente()%>">
                                                                </div>
                                                            </div>
