                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form class="form form-horizontal striped-rows form-bordered" method="POST" action="../ServletDependente?opcao=cadastrar&aluno_id=<%=session.getAttribute("aluno_id")%>">
                                                        <div class="form-body">
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-md-3 label-control" for="tipoDeficiencia">Tipo de Deficiência</label>
                                                                <div class="col-md-9">
                                                                    <input type="text" name="tipoDeficiencia" id="tipoDeficiencia"  class="form-control" placeholder="Deficiência">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
