                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h4 class="card-title" id="striped-row-layout-icons">Lista de Orçamento Mensal</h4>
                                            ...
                                            <div class="card-content collpase show">
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <a href="/pnaes/orcamentoMensal/cadastrar.jsp"><button class="mr-2 mb-2 btn btn-primary" type="button">Incluir Orçamento</button></a>
                                                        </div>
                                                        <div class="col-md-6">
                                                        ...
                                                        <%     
                                                            ...
                                                            List<OrcamentoMensal> orcamentoMensal = new ArrayList<OrcamentoMensal>();
                                                            ...
                                                            orcamentoMensal = daoFactory.getOrcamentoMensalDao().perquisarPorAluno(alunoId);
                                                        %>
                                                        <table class="table table-bordered">
                                                            <tr>
                                                                <th>Nome do Aluno</th> 
                                                                <th>Renda do Aluno</th>
                                                                <th>Renda dos Dependentes</th>
                                                                <th>Renda Outras</th>
                                                                <th>Total</th>
                                                                <th>EDITAR</th>
                                                                <th>EXCLUIR</th>
                                                            ...
                                                            <%
                                                                ...
                                                                for (OrcamentoMensal rm : orcamentoMensal) {
                                                                    for(Dependente d: dependentes){
                                                                        td = d.getRenda();
                                                                    }
                                                                    total1 = rm.getRenda() + td + rm.getOutrasRendas();
                                                            %>
                                                            <tr>
                                                                <td><%=rm.getAluno().getNome()%></td>
                                                                <td><%=rm.getRenda()%></td>
                                                                <td><%=td%></td>
                                                                <td><%=rm.getOutrasRendas()%></td>
                                                                <td><%=total1%></td>
                                                                <td><a href="alterar.jsp?id=<%=rm.getId()%>"><img src="/pnaes/img/editar.png"/></a></td>
                                                                <td><a href="#" onclick="apagar(<%=rm.getId()%>)"><img src="/pnaes/img/excluir.png"/></a></td>
                                                            </tr>
                                                            <% } %>
                                                        </table> 
                                                        <table class="table table-bordered">
                                                            ...
                                                            <%
                                                                ...
                                                                for (OrcamentoMensal dm : orcamentoMensal) {
