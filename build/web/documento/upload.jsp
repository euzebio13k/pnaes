                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">                                                    
                                                    ...
                                                    <input type="file" name="foto" id="target" class="custom-file-input" onchange="uploadFile();">                                    
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">                                                    
                                                    ...
                                                    <input type="file" name="da" id="da" class="custom-file-input">                                                  
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">                                                    
                                                    ...
                                                    <input type="file" name="dr" id="dr" class="custom-file-input">                                                  
                                                </div>
                                            </div>   
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">                                                    
                                                    ...
                                                    <input type="file" name="dd" id="dd" class="custom-file-input">                                                  
                                                </div>
                                            </div>  
                                            <div class="form-group row">
