                                                    ...
                                                    <form class="form form-horizontal striped-rows form-bordered" method="POST" action="../ServletEdital?opcao=cadastrar">
                                                        <div class="form-body">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input type="text" name="dataInicial" id="dataInicial" class="form-control" placeholder="dd/MM/yyyy" required maxlength="10" OnKeyPress="formatar('##/##/####', this)">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-md-3 label-control" for="dataFinal">Data de Encerramento</label>
                                                                <div class="col-md-9">
                                                                    <input type="text" name="dataFinal" id="dataFinal" class="form-control" placeholder="dd/MM/yyyy" required maxlength="10" OnKeyPress="formatar('##/##/####', this)">
                                                                </div>
                                                            </div>
